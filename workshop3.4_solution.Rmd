...
## Prediction
```{r}
pred.w.plim <- predict(birthwt.lm, newdata=data.frame('mother.age'=35,'mother.smokes'='yes'), interval = "prediction")
pred.w.clim <- predict(birthwt.lm,  newdata=data.frame('mother.age'=35,'mother.smokes'='yes'), interval = "confidence")
print(pred.w.plim)
print(pred.w.clim)
print("Predict ")
print(predict(birthwt.lm, newdata=birthwt[20,]))
print("Actual  ")
print(birthwt[20,'birthwt.grams'])
```
